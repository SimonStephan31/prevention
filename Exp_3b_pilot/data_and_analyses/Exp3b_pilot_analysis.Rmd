---
title: "Preemption in Keeping an Effect from Happening Prevention (Pilot study)"
output:  
  html_document:
...
```{r}
# read data 
tdata <- read.table("Exp3b_pilot_data.txt", header=TRUE, sep="\t", na.strings="NA", dec=".", strip.white=TRUE)
...
ggsave("Exp3b_pilot_selections.svg",width=7.5,height=4)
#ggsave("Exp3b_pilot_selections.pdf",width=5,height=4)
```
